...
function objectCreation(){
    ...
    var qustionOne = new questionData("When did Nigeria gain her indepenedence?", "1996", "1960", "1998", "answerTwo");
    var qustionTwo = new questionData("Whos is the Nigeria president elect in 2023?", "Tinubu", "Obi", "Kwankwoso", "answerOne");
    var qustionThree = new questionData("Who is the current President of Nigeria?", "Tinubu", "Obi", "Buhari", "answerThree");
    var qustionFour = new questionData("Who design web pages?", "Web Developer", "UI/UX design", "Data", "answerOne");
    var qustionFive = new questionData("Who design web interface?", "WEb Develop", "Digital Marketing", "UI/UX design", "answerThree");
